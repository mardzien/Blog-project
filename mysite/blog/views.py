...
class PostListView(ListView):
    ...
    def get_queryset(self):
        #published_date__lte - less or equal than
        return Post.objects.filter(published_date__lte = timezone.now()).order_by('-published_date') #-published_date - descending order

class PostDetailViev(DetailView):
    model = Post

class CreatePostView(LoginRequiredMixin, CreateViev):
    login_url = '/login/'
